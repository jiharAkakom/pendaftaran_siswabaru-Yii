	...
	<div class="span2" id="sidebar">
	 <?php  $this->widget('bootstrap.widgets.TbMenu', array(
          ...
          'items'=>array(
                        ...
                        array('label'=>'Pendaftaran', 'icon'=>'user', 'url'=>array('calon/create')),
												array('label'=>'Data Pendaftaran', 'icon'=>'book', 'url'=>array('calon/admin')),
												array('label'=>'Hasil Seleksi', 'icon'=>'book', 'url'=>array('calon/ranking')),
