...
class ThnAjarController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ThnAjar']))
		{
			$model->attributes=$_POST['ThnAjar'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ThnAjar');
	...
	{
		$model=new ThnAjar('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ThnAjar']))
			$model->attributes=$_GET['ThnAjar'];
	...
	{
		$model=ThnAjar::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='thn-ajar-form')
		{
